...
export const translations: Record<Language, Record<string, string>> = {
  ms: {
    ...
    'landing.entrepreneur.desc': 'Daftarkan perniagaan mesra Muslim anda dan capai pelancong di seluruh dunia',
    'landing.enter': 'Masuk',
    ...
    'tourist.featured.subtitle': 'Destinasi mesra Muslim dengan penarafan tertinggi',
  ...
  en: {
    ...
    'landing.entrepreneur.desc': 'Submit your Muslim-friendly business and reach travelers worldwide',
    'landing.enter': 'Enter',
    'landing.login': 'Login',
    ...
    'tourist.featured.subtitle': 'Top rated Muslim-friendly destinations',
