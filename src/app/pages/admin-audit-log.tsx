...
const AUDIT_EVENTS: AuditEvent[] = [
  ...
  { id: 'EVT-011', timestamp: '2026-06-14 09:00:00', actor: 'nurul@halaltourism.com',   role: 'Approver', action: 'Edit',    entity: 'Halal Tourism Article', entityType: 'Content',          detail: 'Updated body text and hero image for featured article.',   ip: '192.168.1.12',   session: 'sess_fff666', status: 'Success' },
